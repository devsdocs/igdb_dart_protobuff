...
class PopularitySourcePopularitySourceEnum extends $pb.ProtobufEnum {
  static const PopularitySourcePopularitySourceEnum POPULARITYSOURCE_POPULARITY_SOURCE_NULL = PopularitySourcePopularitySourceEnum._(0, _omitEnumNames ? '' : 'POPULARITYSOURCE_POPULARITY_SOURCE_NULL');
  static const PopularitySourcePopularitySourceEnum IGDB = PopularitySourcePopularitySourceEnum._(121, _omitEnumNames ? '' : 'IGDB');

  static const $core.List<PopularitySourcePopularitySourceEnum> values = <PopularitySourcePopularitySourceEnum> [
    POPULARITYSOURCE_POPULARITY_SOURCE_NULL,
    IGDB,
  ];

  static final $core.Map<$core.int, PopularitySourcePopularitySourceEnum> _byValue = $pb.ProtobufEnum.initByValue(values);
  static PopularitySourcePopularitySourceEnum? valueOf($core.int value) => _byValue[value];

  const PopularitySourcePopularitySourceEnum._($core.int v, $core.String n) : super(v, n);
}
